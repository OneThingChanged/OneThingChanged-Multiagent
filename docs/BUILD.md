...
| 디버그 NSIS 인스톨러 | `src-tauri/target/debug/bundle/nsis/MultiAgent_0.1.0_x64-setup.exe` |
| 디버그 MSI 인스톨러 | `src-tauri/target/debug/bundle/msi/MultiAgent_0.1.0_x64_en-US.msi` |
...
| NSIS 인스톨러 | ~2MB | `src-tauri/target/release/bundle/nsis/MultiAgent_0.1.0_x64-setup.exe` |
| MSI 인스톨러 | ~3MB | `src-tauri/target/release/bundle/msi/MultiAgent_0.1.0_x64_en-US.msi` |
