...
- **왼쪽 사이드바**: 프로젝트 목록, 선택 프로젝트의 세션 목록, Markdown 패널 토글, 설정, 새 세션 추가
- **가운데 작업 영역**: 탭/분할 터미널
...
- Register projects, then create and switch sessions per project
...
- **Left sidebar**: project list, selected project's session list, Markdown panel toggle, settings, and new-session button
